...
Create-And-Build "avalonia.app" "AvaloniaApp" "C#" "av" "11.1.0-rc1" $binlog
...
Create-And-Build "avalonia.mvvm" "AvaloniaMvvm" "C#" "av" "11.1.0-rc1" $binlog
...
Create-And-Build "avalonia.xplat" "AvaloniaXplat" "C#" "av" "11.1.0-rc1" $binlog
...
Create-And-Build "avalonia.app" "AvaloniaApp" "F#" "av" "11.1.0-rc1" $binlog
...
Create-And-Build "avalonia.mvvm" "AvaloniaMvvm" "F#" "av" "11.1.0-rc1" $binlog
...
Create-And-Build "avalonia.xplat" "AvaloniaXplat" "F#" "av" "11.1.0-rc1" $binlog
